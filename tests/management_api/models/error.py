...
class Error(object):
    ...
    def __init__(self, error=None, request_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def request_id(self):
        ...
        Request ID passed with the request X-Men-Requestid header or generated by the server.  # noqa: E501
